const en = {
  ...
  spotCreation: {
    ...
    visibilityPreviewDescription: 'Visible to all users on the map',
    visibilityHidden: 'Hidden',
    visibilityHiddenDescription: 'Only visible to you',
    assignToTrails: 'Assign to Trails',
    noTrailsSelected: 'Standalone spot (no trail)',
    consentTitle: 'Before you create',
    consentPermission: 'I have permission to create and share this spot.',
    consentCopyright: 'I will not use copyrighted content without permission.',
    consentAppropriate: 'I will not share inappropriate or offensive content.',
    consentPrivacy: 'I will respect the privacy of others and not share personal information without consent.',
    consentResponsibility: 'I understand that I am responsible for the content I create and share.',
