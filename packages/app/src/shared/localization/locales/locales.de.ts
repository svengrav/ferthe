...
const de: LocalizationSet = {
  ...
  spotCreation: {
    ...
    visibilityPreviewDescription: 'Für alle Nutzer auf der Karte sichtbar',
    visibilityHidden: 'Versteckt',
    visibilityHiddenDescription: 'Nur für dich sichtbar',
    assignToTrails: 'Trails zuordnen',
    noTrailsSelected: 'Eigenständiger Spot (kein Trail)',
    consentTitle: 'Bevor du erstellst',
    consentPermission: 'Ich habe die Erlaubnis, diesen Spot zu erstellen und zu teilen.',
    consentCopyright: 'Ich werde keine urheberrechtlich geschützten Inhalte ohne Erlaubnis verwenden.',
    consentAppropriate: 'Ich werde keine unangemessenen oder beleidigenden Inhalte teilen.',
    consentPrivacy: 'Ich werde die Privatsphäre anderer respektieren und keine persönlichen Informationen ohne Zustimmung teilen.',
    consentResponsibility: 'Ich verstehe, dass ich für die Inhalte verantwortlich bin, die ich erstelle und teile.',
