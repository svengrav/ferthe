...
export function PageHeader({ wide }: PageHeaderProps) {
  return (
    <div className="flex items-center justify-center bg-surface text-light text-center border-b border-b-surface-divider py-2 lg:py-6 px-4  z-20 fixed top-0 left-0 right-0">
      <div
        className={clsx(
