...
/**
 * Ferthe API Contract
 * Defines all API endpoints with Zod-validated request/response types
 */
export const apiContract = c.router({
  ...
  getManifest: {
    ...
    path: '/',
    responses: {
      200: successResponse(ManifestSchema),
    },
  ...
  listSpots: {
    ...
    path: '/spot/spots',
    responses: {
      200: pagedSuccessResponse(SpotSchema),
    },
  ...
  listSpotPreviews: {
    ...
    path: '/spot/previews',
    responses: {
      200: pagedSuccessResponse(SpotPreviewSchema),
    },
  ...
  getSpot: {
    ...
    responses: {
      200: successResponse(SpotSchema.optional()),
      404: errorResponse(),
    },
  ...
  createSpot: {
    ...
    responses: {
      200: successResponse(SpotSchema),
      400: errorResponse(),
    },
  ...
  rateSpot: {
    ...
    responses: {
      200: successResponse(SpotRatingSchema),
    },
    summary: 'Rate a spot',
  },
  ...
  getSpotRatingSummary: {
    ...
    pathParams: z.object({ id: z.string() }),
    responses: {
      200: successResponse(RatingSummarySchema),
    },
  ...
  listTrails: {
    ...
    path: '/trail/trails',
    responses: {
      200: pagedSuccessResponse(TrailSchema.passthrough()),
    },
  ...
  getTrail: {
    ...
    pathParams: z.object({ id: z.string() }),
    responses: {
      200: successResponse(TrailSchema.passthrough().optional()),
    },
  ...
  processLocation: {
    ...
    body: z.object({
      locationWithDirection: z.any(), // LocationWithDirection
      trailId: z.string(),
    }),
    responses: {
      200: successResponse(DiscoveryLocationRecordSchema),
    },
  ...
  listDiscoveries: {
    ...
    responses: {
      200: pagedSuccessResponse(DiscoverySchema),
    },
  ...
  getDiscovery: {
    ...
    pathParams: z.object({ id: z.string() }),
    responses: {
      200: successResponse(DiscoverySchema),
      404: errorResponse(),
    },
  ...
  listDiscoveredSpots: {
    ...
    responses: {
      200: pagedSuccessResponse(DiscoverySpotSchema),
    },
    query: TrailFilterQuerySchema,
  ...
  getDiscoveredPreviewClues: {
    ...
    responses: {
      200: successResponse(z.array(ClueSchema)),
    },
  ...
  getDiscoveryTrail: {
    ...
    pathParams: z.object({ trailId: z.string() }),
    responses: {
      200: successResponse(DiscoveryTrailSchema),
    },
  ...
  getDiscoveryProfile: {
    ...
    responses: {
      200: successResponse(DiscoveryProfileSchema),
    },
  ...
  updateDiscoveryProfile: {
    method: 'PUT',
    path: '/discovery/profile',
    body: z.any(), // DiscoveryProfileUpdateData
    responses: {
      200: successResponse(DiscoveryProfileSchema),
    },
  ...
  getDiscoveryStats: {
    ...
    responses: {
      200: successResponse(DiscoveryStatsSchema),
    },
  ...
  getDiscoveryContent: {
    ...
    pathParams: z.object({ discoveryId: z.string() }),
    responses: {
      200: successResponse(DiscoveryContentSchema.optional()),
    },
  ...
  upsertDiscoveryContent: {
    ...
    path: '/discovery/discoveries/:discoveryId/content',
    pathParams: z.object({ discoveryId: z.string() }),
    body: z.any(), // DiscoveryContent
    responses: {
      200: successResponse(DiscoveryContentSchema),
    },
  ...
  createWelcomeDiscovery: {
    ...
    body: z.object({
      location: z.any(), // GeoLocation
    }),
    responses: {
      200: successResponse(WelcomeDiscoveryResultSchema),
    },
  ...
  getSpotsByIds: {
    ...
    responses: {
      200: successResponse(z.array(SpotSchema)),
    },
  ...
  createTrail: {
    method: 'POST',
    path: '/trail/trails',
    body: z.any(), // Trail without id
    responses: {
      200: successResponse(TrailSchema.passthrough()),
      400: errorResponse(),
    },
  ...
  getTrailSpots: {
    ...
    pathParams: z.object({ trailId: z.string() }),
    responses: {
      200: successResponse(z.array(TrailSpotSchema)),
    },
  ...
  getTrailStats: {
    ...
    pathParams: z.object({ trailId: z.string() }),
    responses: {
      200: successResponse(TrailStatsSchema),
    },
  ...
  addSpotToTrail: {
    ...
    responses: {
      200: successResponse(StoredTrailSpotSchema),
    },
  ...
  rateTrail: {
    ...
    body: z.object({ rating: z.number().int().min(1).max(5) }),
    responses: {
      200: successResponse(TrailRatingSchema),
    },
  ...
  listScanEvents: {
    ...
    path: '/sensor/scans',
    responses: {
      200: pagedSuccessResponse(ScanEventSchema),
    },
    query: z.object({
      trailId: z.string().optional(),
    }),
  ...
  createScanEvent: {
    ...
    path: '/sensor/scans',
    body: z.object({
      userPosition: z.any().optional(), // GeoLocation
      trailId: z.string().optional(),
    }),
    responses: {
      200: successResponse(ScanEventSchema),
    },
  ...
  requestSMSCode: {
    ...
    responses: {
      200: successResponse(SMSCodeRequestSchema),
    },
  ...
  verifySMSCode: {
    ...
    responses: {
      200: successResponse(SMSVerificationResultSchema),
      400: errorResponse(),
    },
  ...
  getPublicProfile: {
    ...
    responses: {
      200: successResponse(AccountPublicProfileSchema),
    },
  ...
  getPublicProfiles: {
    ...
    responses: {
      200: successResponse(z.array(AccountPublicProfileSchema)),
    },
  ...
  getAccountProfile: {
    ...
    responses: {
      200: successResponse(AccountSchema.nullable()),
    },
  ...
  updateAccountProfile: {
    method: 'PUT',
    path: '/account/profile',
    body: z.any(), // AccountUpdateData
    responses: {
      200: successResponse(AccountSchema),
    },
  ...
  validateSession: {
    ...
    responses: {
      200: z.any(), // SessionValidationResult
    },
  ...
  createLocalAccount: {
    ...
    body: z.undefined(),
    responses: {
      200: successResponse(AccountSessionSchema),
    },
  ...
  getFirebaseConfig: {
    ...
    responses: {
      200: successResponse(FirebaseConfigSchema),
    },
  ...
  registerDeviceToken: {
    ...
    responses: {
      200: successResponse(DeviceTokenSchema),
    },
  ...
  createCommunity: {
    ...
    responses: {
      200: successResponse(CommunitySchema),
      400: errorResponse(),
    },
  ...
  listCommunities: {
    ...
    path: '/community/communities',
    responses: {
      200: successResponse(z.array(CommunitySchema)),
    },
  ...
  getCommunity: {
    ...
    responses: {
      200: successResponse(CommunitySchema.optional()),
    },
  ...
  listCommunityMembers: {
    ...
    pathParams: z.object({ communityId: z.string() }),
    responses: {
      200: successResponse(z.array(CommunityMemberSchema)),
    },
  ...
  shareDiscovery: {
    ...
    body: z.undefined(),
    responses: {
      200: successResponse(SharedDiscoverySchema),
    },
  ...
  getSharedDiscoveries: {
    ...
    pathParams: z.object({ communityId: z.string() }),
    responses: {
      200: successResponse(z.array(DiscoverySchema)),
    },
  ...
  getContentPage: {
    ...
    responses: {
      200: successResponse(ContentPageSchema),
      404: errorResponse(),
    },
  ...
  listBlogPosts: {
    ...
    responses: {
      200: successResponse(z.array(BlogPostSchema)),
    },
  ...
  getBlogPost: {
    ...
    responses: {
      200: successResponse(BlogPostSchema),
      404: errorResponse(),
    },
  ...
  getDiscoveryState: {
    ...
    responses: {
      200: successResponse(DiscoveryStateSchema),
    },
  ...
  activateTrail: {
    ...
    responses: {
      200: successResponse(ActivateTrailResultSchema),
    },
