...
export const ERROR_CODES = {
  ...
  UPDATE_COMMUNITY_ERROR: { code: 'UPDATE_COMMUNITY_ERROR', message: 'Failed to update community', httpStatus: 500 },
  ...
  GET_PROFILES_ERROR: { code: 'GET_PROFILES_ERROR', message: 'Failed to retrieve member profiles', httpStatus: 500 },
